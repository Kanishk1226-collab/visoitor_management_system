    ...
    <th>OCCURENCE</th>
		...
		<tbody>
			<?php
				...
				$query = $conn->query("SELECT WhomtoMeet, COUNT(*) AS `num` FROM visitor GROUP BY WhomtoMeet");
				while($fetch = $query->fetch_array()){

			?>

			<tr>
				<td style="text-align:center;"><?php echo $fetch['WhomtoMeet']?></td>
...
<body>
    ...
    <div style="width:60%;height:20%;text-align:center">
            ...
            <div>PERSON WHOM HAVE VISITED MANY TIMES BY VISITORS</div>
