    ...
    <th>Out Time</th>
		...
		<tbody>
			<?php
				...
				$query = $conn->query("select *from visitor where date(EnterDate) between '$fdate' and '$tdate'");
        ...
        <td style="text-align:center;"><?php echo $fetch['EnterDate']?></td>
        <td style="text-align:center;"><?php echo $fetch['outtime']?></td>
