...
$reasontomeet=$_POST['reasontomeet'];
 $query=mysqli_query($con,"insert into visitor(FullName,Email,MobileNumber,Address,WhomtoMeet,Department,ReasontoMeet) value('$fullname','$email','$mobnumber','$add','$whomtomeet','$department','$reasontomeet')");
